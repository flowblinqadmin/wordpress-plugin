<?php
/**
 * ES-042 — Unit tests for Fqgeo_Proxy (U1-U23) and Admin/Uninstall (U24-U30).
 *
...
if ( PHP_VERSION_ID >= 70400 ) {
    ...
    // Minimal stub for Fqgeo_API_Client
    if ( ! class_exists( 'Fqgeo_API_Client' ) ) {
